...
// nest that took it, under the name "scalpel", with its new location as
// the value.

// This means that finding the scalpel is a matter of following the breadcrumb
// trail of storage entries, until you find a nest where that points at the
// nest itself.
...
// enough that you may assume that every nest has a "scalpel" entry in its
// data storage.
