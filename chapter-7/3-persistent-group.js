...
// which stores a set of values. Like Group, it has add, delete, and
// has methods.
...
//   you’ll definitely want to use it internally). Instead, there is
//   an empty instance, PGroup.empty, that can be used as a starting value.
